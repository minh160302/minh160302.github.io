...
interface NauvusProps {
  children: React.ReactNode
}

type Props = NauvusProps & IState & IDispatch

const Nauvus: React.FC<Props> = (props) => {
...
export default connect(mapStateToProps, mapDispatchToProps)(Nauvus);